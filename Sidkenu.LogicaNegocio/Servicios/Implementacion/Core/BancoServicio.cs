...
namespace Sidkenu.LogicaNegocio.Servicios.Implementacion.Core
{
    ...
    {
        public BancoServicio(IMapper mapper,
        ...
        public ResultDTO Add(BancoPersistenciaDTO entidad, string user)
        {
            ...
            try
            {
                ...
                var entity = _mapper.Map<Banco>(entidad);
        ...
        public ResultDTO Update(BancoPersistenciaDTO entidad, string user)
        {
            ...
            try
            {
                var entityActual = _context.Bancos.Find(entidad.Id);
        ...
        public ResultDTO Delete(BancoDeleteDTO deleteDTO, string user)
        {
            ...
            try
            {
                var entidad = _context.Bancos.Find(deleteDTO.Id);
        ...
        private bool VerificarSiExiste(string descripcion, Guid? empresaId, Guid? id = null)
        {
            ...
            if (id == null)
            {
                ...
                {
                    return _context.Bancos.Any(x => x.EmpresaId == empresaId.Value && x.Descripcion.ToLower() == descripcion.ToLower());
                }
                else
                {
                    return _context.Bancos.Any(x => x.Descripcion.ToLower() == descripcion.ToLower());
                }
            }
            else
            {
                if (empresaId.HasValue)
                {
                    return _context.Bancos.Any(x => x.Id != id.Value
