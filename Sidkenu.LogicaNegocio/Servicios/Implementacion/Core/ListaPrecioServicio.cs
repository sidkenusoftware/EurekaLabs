...
namespace Sidkenu.LogicaNegocio.Servicios.Implementacion.Core
{
    ...
    {
        public ListaPrecioServicio(IMapper mapper,
        ...
        public ResultDTO Add(ListaPrecioPersistenciaDTO entidad, string user)
        {
            ...
            try
            {
                ...
                var entity = _mapper.Map<ListaPrecio>(entidad);

                entity.User = user;
                entity.EstaEliminado = false;

                _context.ListaPrecios.Add(entity);
        ...
        public ResultDTO Update(ListaPrecioPersistenciaDTO entidad, string user)
        {
            ...
            try
            {
                var entityActual = _context.ListaPrecios.Find(entidad.Id);
                ...
                _context.ListaPrecios.Update(entity);
        ...
        public ResultDTO Delete(ListaPrecioDeleteDTO deleteDTO, string user)
        {
            ...
            try
            {
                var entidad = _context.ListaPrecios.Find(deleteDTO.Id);
        ...
        public ResultDTO GetAll()
        {
            ...
            try
            {
                var entities = _context.ListaPrecios
                    .AsNoTracking()
                    .ToList();
        ...
        public ResultDTO GetAll(Guid empresaId)
        {
            ...
            try
            {
                Expression<Func<ListaPrecio, bool>> filtro = filtro => true;
        ...
        public ResultDTO GetById(Guid id)
        {
            ...
            try
            {
                var entity = _context.ListaPrecios.Find(id);
        ...
        private bool VerificarSiExiste(string descripcion, Guid? empresaId, Guid? id = null)
        {
            ...
            if (id == null)
            {
                ...
                {
                    return _context.ListaPrecios.Any(x => x.EmpresaId == empresaId.Value && x.Descripcion.ToLower() == descripcion.ToLower());
                }
                else
                {
                    return _context.ListaPrecios.Any(x => x.Descripcion.ToLower() == descripcion.ToLower());
                }
            }
            else
            {
                if (empresaId.HasValue)
                {
                    return _context.ListaPrecios.Any(x => x.Id != id.Value
