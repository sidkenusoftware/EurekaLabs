...
namespace Sidkenu.LogicaNegocio.Servicios.Implementacion.Core
{
    ...
    {
        public FamiliaServicio(IMapper mapper,
        ...
        public ResultDTO Add(FamiliaPersistenciaDTO entidad, string user)
        {
            ...
            try
            {
                ...
                var entity = _mapper.Map<Familia>(entidad);
        ...
        public ResultDTO Update(FamiliaPersistenciaDTO entidad, bool actualizarPrecio, string user)
        {
            ...
            try
            {   
                var entityActual = _context.Familias.Find(entidad.Id);
        ...
        public ResultDTO Delete(FamiliaDeleteDTO deleteDTO, string user)
        {
            ...
            try
            {
                var entidad = _context.Familias.Find(deleteDTO.Id);
        ...
        public ResultDTO GetAll()
        {
            ...
            try
            {
                var entities = _context.Familias
                    .AsNoTracking()
                    .ToList();
        ...
        public ResultDTO GetAll(Guid empresaId)
        {
            ...
            try
            {
                Expression<Func<Familia, bool>> filtro = filtro => true;
        ...
        public ResultDTO GetById(Guid id)
        {
            ...
            try
            {
                var entity = _context.Familias.Find(id);
        ...
        private bool VerificarSiExiste(string descripcion, Guid? empresaId, Guid? id = null)
        {
            ...
            if (id == null)
            {
                ...
                {
                    return _context.Familias.Any(x => x.EmpresaId == empresaId.Value && x.Descripcion.ToLower() == descripcion.ToLower());
                }
                else
                {
                    return _context.Familias.Any(x => x.Descripcion.ToLower() == descripcion.ToLower());
                }
            }
            else
            {
                if (empresaId.HasValue)
                {
                    return _context.Familias.Any(x => x.Id != id.Value
