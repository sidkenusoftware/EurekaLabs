...
namespace Sidkenu.Infraestructura.Migrations
{
    ...
    [Migration("20240219182603_addCampoCobrarTicketCaja")]
    partial class addCampoCobrarTicketCaja
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Core.Cliente", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bb226d47-2c65-49f7-8aa3-ece3a2982641"),
                            ...
                            Telefono = "9999999",
                            TipoDocumentoId = new Guid("ee1239bf-652a-40ce-8163-03736fa9a0b9"),
                            TipoResponsabilidadId = new Guid("62940b18-9d5c-40d8-adb7-4b060993e431"),
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Core.CondicionIva", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("34656c2b-aae3-4c28-b050-b94b8a4e2d8f"),
                        ...
                        new
                        {
                            Id = new Guid("2cfc1fc1-4a4a-4331-b5e0-6b156846e873"),
                        ...
                        new
                        {
                            Id = new Guid("1d2eccc2-59fe-4cb8-9329-1744f3c44278"),
                            AplicaParaFacturaElectronica = true,
                            Codigo = "2",
                            Descripcion = "Exento",
                            EstaEliminado = false,
                        ...
                        new
                        {
                            Id = new Guid("84e86051-143b-4d21-aa1d-aaf2cadd2fe4"),
                            AplicaParaFacturaElectronica = true,
                            Codigo = "3",
                            Descripcion = "0 %",
                            EstaEliminado = false,
                        ...
                        new
                        {
                            Id = new Guid("42acfb1e-32e4-4931-ac75-859f38c528be"),
                            AplicaParaFacturaElectronica = true,
                            Codigo = "4",
                            Descripcion = "10,50 %",
                            EstaEliminado = false,
                        ...
                        new
                        {
                            Id = new Guid("42c2ba16-61ce-4563-b4f7-86e8369b86fc"),
                            AplicaParaFacturaElectronica = true,
                            Codigo = "5",
                            Descripcion = "21 %",
                            EstaEliminado = false,
                        ...
                        new
                        {
                            Id = new Guid("317e71a2-023b-4036-96aa-5a0e8f0ac0bc"),
                            AplicaParaFacturaElectronica = true,
                            Codigo = "6",
                            Descripcion = "27 %",
                            EstaEliminado = false,
                        ...
                        new
                        {
                            Id = new Guid("17036a76-b695-4cdf-9a4d-95a92e749a40"),
                            AplicaParaFacturaElectronica = true,
                            Codigo = "7",
                            Descripcion = "Gravado",
                            EstaEliminado = false,
                        ...
                        new
                        {
                            Id = new Guid("aae9a093-a47c-4aa9-9fee-160dff931990"),
                            AplicaParaFacturaElectronica = true,
                            Codigo = "8",
                            Descripcion = "5 %",
                            EstaEliminado = false,
                        ...
                        new
                        {
                            Id = new Guid("93fb75f6-166d-484e-8902-051a713042bf"),
                            AplicaParaFacturaElectronica = true,
                            Codigo = "9",
                            Descripcion = "2,50 %",
                            EstaEliminado = false,
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Core.ConfiguracionCore", b =>
                {
                    ...
                    b.Property<bool>("ActivarCobroConTicketCaja")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Core.TipoDocumento", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a9b98ad3-1a16-4ad0-9617-0b9813956a95"),
                        ...
                        new
                        {
                            Id = new Guid("a14d8f08-51ad-4350-8b3d-cbaeceb7113e"),
                            Descripcion = "CUIT",
                            EstaEliminado = false,
                            User = "semilla@tsidkenu.com"
                        },
                        new
                        {
                            Id = new Guid("a5bd2ae0-67f4-4ceb-a175-1063f40196b1"),
                            Descripcion = "CUIL",
                            EstaEliminado = false,
                            User = "semilla@tsidkenu.com"
                        },
                        new
                        {
                            Id = new Guid("ee1239bf-652a-40ce-8163-03736fa9a0b9"),
                            Descripcion = "DNI",
                            EstaEliminado = false,
                            User = "semilla@tsidkenu.com"
                        },
                        new
                        {
                            Id = new Guid("3a975825-1e72-46e0-a3fb-b491efc971f7"),
                        ...
                        new
                        {
                            Id = new Guid("2ea4a24c-6cc6-4481-a859-07dcc1f12dff"),
                        ...
                        new
                        {
                            Id = new Guid("513cd370-47a7-4c03-ac07-a962ba0092a3"),
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Core.Variante", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ae8c2b28-ff6d-4485-8d2d-1015bb897949"),
                            Codigo = "VAR9999",
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Core.VarianteValor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1718080b-77c8-4051-8136-e15cdceb60dd"),
                            Codigo = "VAR9999",
                            Descripcion = "Variante Valor Defecto",
                            EstaEliminado = false,
                            User = "semilla@tsidkenu.com",
                            VarianteId = new Guid("ae8c2b28-ff6d-4485-8d2d-1015bb897949")
                        });
                });
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Seguridad.ConfiguracionSeguridad", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("31453675-01d6-401b-a7bf-7b2dbe4d60e4"),
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Seguridad.IngresoBruto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("29d00180-6a9f-4335-ae32-471e38d55845"),
                        ...
                        new
                        {
                            Id = new Guid("dc29588f-ec64-49b4-b699-247edb4b210b"),
                            Descripcion = "Local ",
                            EstaEliminado = false,
                            User = "semilla@tsidkenu.com"
                        },
                        new
                        {
                            Id = new Guid("79b2fe63-5d82-4150-957a-e46a30a81074"),
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Seguridad.Localidad", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ee48a17a-fdae-4d4e-abdb-7e9390bfcfe7"),
                            Descripcion = "San Miguel de Tucuman",
                            EstaEliminado = false,
                            ProvinciaId = new Guid("e240afba-8347-453e-9455-8b1ad3beb43c"),
                            User = "semilla@tsidkenu.com"
                        });
                });
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Seguridad.Provincia", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e240afba-8347-453e-9455-8b1ad3beb43c"),
                            Descripcion = "Tucuman",
                            EstaEliminado = false,
                            User = "semilla@tsidkenu.com"
                        });
            ...
            modelBuilder.Entity("Sidkenu.Dominio.Entidades.Seguridad.TipoResponsabilidad", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b4b1f22f-b3ce-44fd-88f8-1a839015a42d"),
                            Codigo = 1,
                        ...
                        new
                        {
                            Id = new Guid("2a424764-c3fc-425c-af03-ab45eafe6b73"),
                            Codigo = 4,
                        ...
                        new
                        {
                            Id = new Guid("62940b18-9d5c-40d8-adb7-4b060993e431"),
                            Codigo = 5,
                        ...
                        new
                        {
                            Id = new Guid("15653335-8b81-4b66-8757-d7815d54f848"),
                            Codigo = 6,
                        ...
                        new
                        {
                            Id = new Guid("5d602ed3-9011-42cb-aff5-f657d6e6fd4e"),
                            Codigo = 8,
                        ...
                        new
                        {
                            Id = new Guid("2053f429-a2f4-465a-a5f4-d787b7b9209f"),
                            Codigo = 9,
                        ...
                        new
                        {
                            Id = new Guid("12da45d8-8526-4dc7-8304-8d637d93a6be"),
                            Codigo = 10,
                        ...
                        new
                        {
                            Id = new Guid("fe124fa1-6bb4-459a-9ae4-b5e669ae2918"),
                            Codigo = 13,
                        ...
                        new
                        {
                            Id = new Guid("30fe0342-996d-4df3-8751-81c7b2fedfea"),
                            Codigo = 15,
